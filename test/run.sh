...
${test_mc_dir}/test_mc ${result_dir} 2 2 1 true

${test_mc_dir}/test_mc ${result_dir} 2 2 1
${test_mc_dir}/test_mc ${result_dir} 4 4 1
${test_mc_dir}/test_mc ${result_dir} 10 10 1
